...
const Home = () => (
  <div className="flex-grow flex flex-col min-h-[100vh] mt-4 mb-16 pb-16 bg-gray-100">
    ...
    <div className="flex justify-center px-6">
      <div className="grid grid-cols-1 border-slate-900 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl">
        {[ 
          ...
          { name: 'Alex', rating: 4, review: " Great experience with the IELTS program. The study materials were very detailed, and the mock tests helped me a lot. Highly recommended for anyone looking to improve their English The instructors were knowledgeable" }
        ].map((student, index) => (
    ...
    <div className="flex bg-gradient-to-r from-indigo-500 to-blue-500 border border-slate-400 rounded-lg shadow-lg max-w-6xl mx-auto mt-8 overflow-hidden">
